execute as @p[x=10,y=190,z=1,team=Lobby] run tellraw @a [{"text":"["},{"text":"TGH Hunger Games","color":"#FFA300","bold":true},{"text":"] ","extra":[{"selector":"@s"},{"text":" has entered the game!"}]}]
...
execute if score tghhgDummy startingPosition matches 1 run tp @p[x=10,y=190,z=1] 11.5 5 -10.5
...
execute if score tghhgDummy startingPosition matches 2 run tp @p[x=10,y=190,z=1] -15.5 5 0.5
...
execute if score tghhgDummy startingPosition matches 3 run tp @p[x=10,y=190,z=1] 11.5 5 11.5
...
execute if score tghhgDummy startingPosition matches 4 run tp @p[x=10,y=190,z=1] 0.5 5 16.5
...
execute if score tghhgDummy startingPosition matches 5 run tp @p[x=10,y=190,z=1] -10.5 5 -10.5
...
execute if score tghhgDummy startingPosition matches 6 run tp @p[x=10,y=190,z=1] -15.5 5 0.5
...
execute if score tghhgDummy startingPosition matches 7 run tp @p[x=10,y=190,z=1] -10.5 5 -10.5
