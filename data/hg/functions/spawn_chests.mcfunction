...
setblock -69 8 8 chest{LootTable:"hg:mctools/chest_basic"} replace
setblock -96 7 27 chest{LootTable:"hg:mctools/chest_awesome"} replace
setblock -100 6 17 chest{LootTable:"hg:mctools/chest_basic"} replace
setblock -88 6 17 chest{LootTable:"hg:mctools/chest_good"} replace
setblock -106 6 -9 chest{LootTable:"hg:mctools/chest_middle"} replace
setblock -80 23 -19 chest{LootTable:"hg:mctools/chest_good"} replace
setblock -72 18 -11 chest{LootTable:"hg:mctools/chest_good"} replace
setblock -67 24 -9 chest{LootTable:"hg:mctools/chest_basic"} replace
setblock -62 5 -38 chest{LootTable:"hg:mctools/chest_good"} replace